...
import com.abdelrahman.myreads.MyReads.payload.ExceptionResponse;
...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ApiResponse> resolveException(ApiError exception){
	...
	@ExceptionHandler(UnActivatedUser.class)
	@ResponseBody
	public ResponseEntity<ApiResponse> resolveException(UnActivatedUser exception){
		ApiResponse apiResponse = exception.getApiResponse();
